...
<body>
    <!-- Sticky-top navbar -->
     ...
     <div id="property-images" class="carousel slide" data-ride="carousel">
         ...
         <button class="carousel-control-prev" type="button" data-target="#property-images" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next" type="button" data-target="#property-images" data-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Next</span>
         </button>
         </div>

        <!-- Property image page container -->
         <div class="property-summary image-container">
             ...
             ?>
                 <div class="star-container col" title="<?= $total_rating ?>">
                 <?php
                 $rating = $total_rating;
                 for ($i = 0; $i < 5; $i++) {
                     if ($rating >= $i + 0.8) {
                 ...
                 <div class="interested-container col">
                     <?php
                     $is_interested = false;
